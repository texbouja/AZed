...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "AZed"),
        "preview" => ("app-icon-preview.ico", "AZed Preview"),
        "nightly" => ("app-icon-nightly.ico", "AZed Nightly"),
        _ => ("app-icon-dev.ico", "AZed Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "AZed Project\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2026 Zed Industries, Inc. (original), AZed Project\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
