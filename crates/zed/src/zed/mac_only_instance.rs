...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "AZed Dev Instance Running",
        ReleaseChannel::Nightly => "AZed Nightly Instance Running",
        ReleaseChannel::Preview => "AZed Preview Instance Running",
        ReleaseChannel::Stable => "AZed Instance Running",
    }
}
